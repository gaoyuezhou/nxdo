...
TINY_BRIDGE_2p_env = 'tiny_bridge_2p_env' ####
...
class TinyBridge2pMultiAgentEnv(ValidActionsMultiAgentEnv):
    ...
    def step(self, action_dict):
        ...
        if True: ### always return rewards and infos for both players
            ...
            #     self.curr_time_step.rewards)  # should not be the case since it's coorperative
...
register_env(TINY_BRIDGE_2p_env, lambda env_config: TinyBridge2pMultiAgentEnv(env_config)) ####

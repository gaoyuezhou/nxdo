...
if __name__ == "__main__":
    ...
    experiment_name = f"tiny_bridge_hyperparam_search_mappo_metanash"
    num_cpus = 6
    num_gpus = 0
    ...
    metanash_pol_scenario: PSROScenario = scenario_catalog.get(scenario_name="tiny_bridge_4p_psro")
    ...
    # {'custom_model': 'cc_model', 'vf_share_layers': False}

    payoff_table_path = "/home/gaoyue/nxdo/grl/data/psro_tiny_bridge_4p/payoff_table_checkpoint_latest.json"
